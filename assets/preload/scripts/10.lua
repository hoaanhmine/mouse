...
-- so if the bg or here "Image" x is going to -500 and the text x is in 50 so you do -500+25 and thats -475 you do that so you wouldnt have delay belive me in the first version they were all going to -500
    ...
    setTextString("Charter", "By: Kiwiquest")
end
...
-- Make it slide in and out
    if curStep == 3 then
        doTweenX("ImageTweenX", "Image", -120, 1.6, 'expoOut')
        doTweenX("Image2TweenX", "Image2", -100, 2.1, 'expoOut')
        doTweenX("SlideIn3", "Maker", 465, 1.3, 'expoOut')
        doTweenX("SlideIn4", "Charter", 465, 1.3, 'expoOut')
        doTweenX("SlideIn6", "Icon2", 660, 1, 'expoOut')
        doTweenAngle("Spin", "Disk", 2000, 5, 'expoOut')
    end
    if curStep == 4 then
        doTweenX("SlideIn5", "Disk", 390, 1.7, 'expoOut')
    end
    if curStep == 25 then
        doTweenX("SlideOut3", "Maker", 1775, 1, 'expoIn')
        doTweenX("SlideOut4", "Charter", 1775, 1, 'expoIn')
        doTweenX("SlideOut6", "Icon2", 2075, 1, 'expoIn')
    end
    if curStep == 26 then
        doTweenX("ImageTweenX", "Image", 1400, 1, 'expoIn')
        doTweenX("Image2TweenX", "Image2", 1400, 1, 'expoIn')
        doTweenX("SlideOut5", "Disk", 2075, 1, 'expoIn')
    end
end
